...
parser.add_argument(
    "--repeats", dest="repeats", default=5, type=int, help="repeats"
)
parser.add_argument(
    "--partition", dest="partition", default="valid", type=str, help="partition"
)
parser.add_argument(
    "--single_frag_only", dest="single_frag_only", default=1, type=int, help="single_frag_only"
)
parser.add_argument(
    "--model", dest="model", default="leftnet", type=str, help="model"
)
parser.add_argument(
