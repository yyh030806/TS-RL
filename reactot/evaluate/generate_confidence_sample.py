...
parser.add_argument(
    "--bz", dest="bz", default=32, type=int, help="batch size"
)
parser.add_argument(
...
parser.add_argument(
    "--repeats", dest="repeats", default=1, type=int, help="repeats"
)
parser.add_argument(
...
parser.add_argument(
    "--position_key", dest="position_key", default="positions", type=str, help="position_key"
)
...
tspath = "/home/ubuntu/efs/TSDiffusion/reactot/trainer/ckpt/TSDiffusion-TS1x-All"
checkpoints = {
...
for num_repeat in range(config["repeats"]):
    ...
    for ii, batch in enumerate(loader):
        ...
        print("rmsds: ", [round(_x, 2) for _x in data["rmsd"]], np.mean(data["rmsd"]), np.median(data["rmsd"]))
